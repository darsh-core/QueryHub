...
def init_db():
    ...
    dsa_modules_data = [
        {
            "code": "DSA-101",
            "title": "Module 1: Introduction to Data Structures & Algorithm Analysis",
        ...
        {
            "code": "DSA-102",
            "title": "Module 2: Arrays, Dynamic Arrays & Two-Pointer Techniques",
        ...
        {
            "code": "DSA-104",
            "title": "Module 4: Stacks, Queues & Monotonic Stack Applications",
        ...
        {
            "code": "DSA-106",
            "title": "Module 6: Binary Heaps & Priority Queues",
        ...
        {
            "code": "DSA-107",
            "title": "Module 7: Hash Tables & Collision Resolution Techniques",
        ...
        {
            "code": "DSA-109",
            "title": "Module 9: Graph Traversals (BFS, DFS) & Shortest Path",
    ...
    for m_data in all_modules_data:
        ...
        # (AIQuestions pre-seeding removed: all questions must be RAG generated dynamically)
        db.commit()
